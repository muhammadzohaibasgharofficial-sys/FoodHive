...
// Country IDs match the Activepieces flow EXACTLY
// ============================================================
...
export const RECIPE_CATEGORIES = [
  ...
  { id: 'soups',      name: 'Soups and Stews',  icon: '🍲', desc: 'Warm, comforting bowls.' },
  { id: 'pasta',      name: 'Pasta and Noodles',icon: '🍝', desc: 'World noodle dishes in one place.' },
  ...
  { id: 'baking',     name: 'Baking and Bread', icon: '🥖', desc: 'Fresh baked goods from your oven.' }
]
...
// ── VALIDATE RECIPE — must have all required fields ──
...
// ── READ ALL RECIPES from data/recipes/ ──
...
// ── GET ALL RECIPE SLUGS for getStaticPaths ──
...
// ── SAMPLE RECIPE — shown when no recipes exist yet ──
export const SAMPLE_RECIPE = {
  slug: 'sample-chicken-karahi',
  ...
  description: 'Chicken Karahi is a bold, smoky Pakistani dish cooked in a wok with tomatoes, green chilies, and fragrant spices. It is one of the most beloved dishes in Pakistani cuisine, bursting with rich flavor.',
  ingredients: [
    { item: 'Chicken', amount: '1 kg', notes: 'bone-in, cut into pieces' },
    { item: 'Tomatoes', amount: '4 medium', notes: 'chopped' },
    { item: 'Green chilies', amount: '4-5', notes: 'slit' },
    { item: 'Ginger garlic paste', amount: '2 tbsp', notes: '' },
    { item: 'Oil', amount: '1/4 cup', notes: '' },
    { item: 'Salt', amount: 'to taste', notes: '' }
  ],
  instructions: [
    { step: 1, title: 'Heat the karahi', text: 'Heat oil in a heavy wok over high heat until smoking.', time: '2 min' },
    { step: 2, title: 'Cook chicken', text: 'Add chicken and sear on high heat until lightly browned all over.', time: '8 min' },
    { step: 3, title: 'Add tomatoes and spices', text: 'Add ginger garlic paste, tomatoes, and salt. Cook until oil separates.', time: '15 min' },
    { step: 4, title: 'Finish and serve', text: 'Add green chilies and ginger julienne. Serve hot with naan.', time: '5 min' }
  ],
  nutritionTable: { calories: '420 kcal', protein: '35g', carbs: '8g', fat: '28g', fiber: '2g', sugar: '4g', sodium: '680mg', cholesterol: '110mg' },
  tags: ['Pakistani', 'Chicken', 'Karahi', 'Authentic', 'Traditional'],
  tips: [
    'Use a heavy steel karahi for authentic smoky flavor.',
    'Cook on high heat — do not lower the flame.',
    'Garnish with fresh ginger julienne and coriander before serving.'
  ],
  rating: 4.9,
  reviews: 521,
